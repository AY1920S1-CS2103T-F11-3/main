...
import static seedu.address.logic.parser.util.CliSyntax.PREFIX_CARDNUMBER;
import static seedu.address.logic.parser.util.CliSyntax.PREFIX_CVC;
 ...
 */
public class AddCardCommandParser implements CommandParser<AddCardCommand> {
