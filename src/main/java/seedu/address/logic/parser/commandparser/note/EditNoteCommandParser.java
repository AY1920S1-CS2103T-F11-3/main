...
import static seedu.address.logic.parser.util.CliSyntax.PREFIX_CONTENT;
...
import static seedu.address.logic.parser.util.CliSyntax.PREFIX_TITLE;
 ...
 */
public class EditNoteCommandParser implements CommandParser<EditNoteCommand> {
